...
public class Movies  {
    ...
    public void goToMovies(Stage s)throws IOException,Exception{
            ...
            InputStream p1Input = new FileInputStream("Images\\Movies\\logo\\agent.jpeg");
            InputStream p2Input = new FileInputStream("Images\\Movies\\logo\\bhola.JPG");
            InputStream p3Input = new FileInputStream("Images\\Movies\\logo\\ib71.JPG");
            InputStream p4Input = new FileInputStream("Images\\Movies\\logo\\pathan.JPG");
            InputStream p5Input = new FileInputStream("Images\\Movies\\logo\\gadar.jpg");


           //Images Input Thriller
            InputStream p1TInput = new FileInputStream("Images\\thriller\\p1.jpeg");
            InputStream p2TInput = new FileInputStream("Images\\thriller\\p2.jpeg");
            InputStream p3TInput = new FileInputStream("Images\\thriller\\p3.jpeg");
            InputStream p4TInput = new FileInputStream("Images\\Movies\\logo\\bloddydaddy.JPG");
            InputStream p5TInput = new FileInputStream("Images\\Movies\\logo\\fredy.JPG");
            ...
            p4IView.setOnMouseClicked(event -> {
                try {
                    info.goToInfo(s, "patthan","movies");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            });
            ...
            p1TIView.setOnMouseClicked(event -> {
                try {
                    info.goToInfo(s, "Die Hard","movies");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            });
            p2TIView.setOnMouseClicked(event -> {
                try {
                    info.goToInfo(s, "Michael","movies");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            });
            ...
            //hBox4
            //Thriller
            Text thrillerTxt = new Text("Thriller");
